...
# basic config
parser.add_argument('--num_stock', type=int, default=155, help='num_stock')
...
parser.add_argument('--root_path', type=str, default='./data/CSI300', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='CSI300_155_data_ALL.pt', help='data csv file')
